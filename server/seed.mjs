...
const user = { id: "demo-user", email: "demo@nuelifi.app", name: "Demo User", goals: ["balanced meals", "consistent movement"], preferences: { units: "metric", notifications: true }, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() };
