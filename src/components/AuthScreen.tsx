...
export function AuthScreen({ onPreview, onAuthenticated, themeMode, onThemeChange, initialMode = "signup", initialEmail = "" }: { onPreview: () => void; onAuthenticated: () => void; themeMode: ThemeMode; onThemeChange: (mode: ThemeMode) => Promise<void>; initialMode?: "signin" | "signup"; initialEmail?: string }) {
  ...
  const signInWithGoogle = async () => {
    ...
    } catch (value) { setBusy(false); setMessage(value instanceof Error ? value.message : "Google sign-in could not be started."); }
  };
