...
export function AuthScreen({ onPreview, onAuthenticated, themeMode, onThemeChange, initialMode = "signup" }: { onPreview: () => void; onAuthenticated: () => void; themeMode: ThemeMode; onThemeChange: (mode: ThemeMode) => Promise<void>; initialMode?: "signin" | "signup" }) {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "signup") setMessage(`Check your email to confirm your account. The link will return to your dashboard at ${redirectTo}.`);
