...
function PublicNav({ page, onNavigate, onAuth }: { page: PublicPage; onNavigate: (page: PublicPage) => void; onAuth: (mode: "signin" | "signup") => void }) {
  return <header className="public-nav">
    <button className="public-brand" type="button" onClick={() => onNavigate("landing")}><span className="brand-mark">⌁</span><strong>Nuelifi</strong></button>
  ...
  return <main className="public-main public-landing">
    <section className="public-hero public-hero-premium">
      <div className="public-hero-copy">
        ...
        <h1>{title}</h1>
        <p className="public-hero-lede">Turn a meal photo into a clearer next step. Nuelifi brings your meals, daily actions, and personal context together in one private space.</p>
...
function ProductPreview() {
  return <div className="public-product-preview public-product-preview-premium" aria-label="Illustration of the Nuelifi product"><div className="preview-floating-chip preview-chip-top">● Today feels clearer</div><div className="preview-window-bar"><span /><span /><span /></div><div className="preview-window-body"><div className="preview-mini-rail"><span className="preview-mini-logo">⌁</span><i /><i /><i /><i /><i /></div><div className="preview-mini-content"><div className="preview-mini-top"><span>OVERVIEW</span><b>SC</b></div><div className="preview-mini-greeting"><small>MONDAY, JUN 16</small><strong>Good morning, Sarah</strong></div><div className="preview-mini-score"><small>AVERAGE HEALTH SCORE</small><strong>82 <em>/100</em></strong><span><i /></span><label>3 meals analysed <b>4/6 actions done</b></label></div><div className="preview-mini-stats"><div><small>MEALS</small><strong>12</strong></div><div><small>ACTIONS</small><strong>8/11</strong></div><div><small>STREAK</small><strong>5d</strong></div></div><div className="preview-mini-capture"><b>＋</b><span><strong>Analyse a meal</strong><small>Photo or upload — takes 10 seconds</small></span><i>→</i></div></div></div><div className="preview-floating-chip preview-chip-bottom"><span>✓</span> Keep one small action</div></div>;
}
