...
export function MealResults({ meal, actions, onAction, onAddTask, onDone }: { meal: Meal; actions: ResultAction[]; onAction: (id: string) => void; onAddTask: (id: string) => void; onDone: () => void }) {
