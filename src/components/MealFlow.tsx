...
export function MealResults({ meal, actions, onAction, onAddTask, onDone, showFreeAds = false }: { meal: Meal; actions: ResultAction[]; onAction: (id: string) => void; onAddTask: () => void; onDone: () => void; showFreeAds?: boolean }) {
